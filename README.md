...
[![Godoc](https://img.shields.io/badge/godoc-go.rice-blue.svg?style=flat-square)](https://godoc.org/github.com/giter/go.rice)
...
```
go get github.com/giter/go.rice
go get github.com/giter/go.rice/rice
```

### Package usage

Import the package: `import "github.com/giter/go.rice"`
...
You will find package documentation at [godoc.org/github.com/giter/go.rice][godoc].


 [license]: https://github.com/giter/go.rice/blob/master/LICENSE
 [godoc]: http://godoc.org/github.com/giter/go.rice
